	...
	<div id="formContainer">
		<form id="login" action="send_info.php" method="POST">
												...
												<ul>
														...
														<input id="address" name="email"  type="email" placeholder="Email" required="true" title="Valid email address: one or more characters, followed by an @, followed by one or more characters, a '.' and 2 or more characters for domain." pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" onchange="this.setCustomValidity(this.validity.patternMismatch ? 'Must be a valid email address.' : ''); if(this.checkValidity()) form.address.pattern = this.value;">
									...
									input.setCustomValidity('');
												...
												<input type="password"  name="password" id="Password" placeholder="Password" required="true" title="Your password must contain at least one number, one uppercase and lowercase letter, and at least 8 or more characters" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" onchange="this.setCustomValidity(this.validity.patternMismatch ? 'Your password must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters' : ''); if(this.checkValidity()) form.Password.pattern = this.value;">
